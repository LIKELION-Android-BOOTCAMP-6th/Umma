...
data class CorrectionSuggestion(
    ...
    // COR-TUNE-011 / COR-TUNE-011-FIX: 발화 원문 언어(운반용 필드).
    // RT-003 STT 가 turn 단위 언어를 못 주게 되어(detectedLang seam 폐기, Method B), 이제는 AI 교정
    // 응답이 보고한 값을 mapper 가 보수적으로 정규화해 채운다(불명/미지원 → null).
